      ...
      <header className={styles.hero}>
        ...
        <p className={styles.subtitle}>
          {isStrategyGoals ? (
            ...
            <>
              Здесь загружается <strong>Регламент</strong>, который не меняется в течение года. Он автоматически
              подставляется в каждую новую коллекцию на вкладке «База знаний» (вместе с шаблоном стратегии, если он
              загружен).
            </>
          )}
        </p>
